...
function displayToDos() {
  ...
  var it = buildToDos('toDoItems');

  it.forEach(elemento => toDoContainer.push(elemento));
}
...
function addToDo() {
  ...
  newToDo.description = document.getSelection('toDoInput').value;
...
function completeToDo(event) {
  ...
  ToDo.prototype.completeToDo(index);
  displayToDos();
